...
const DotBackground = () => {
  return (
    <div
      id="#home"
      className="h-[50rem] w-full dark:bg-eerie-500 bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center"
    >
      <div className="absolute pointer-events-none inset-0 flex flex-col items-center justify-center dark:bg-eerie-500 bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <h1 className="text-center">full stack developer based in waukegan</h1>
